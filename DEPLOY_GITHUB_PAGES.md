...
URL sau khi deploy: **https://PcHieuDev.github.io/Kiem_tra_thiet_bi/**
...
git init
git remote add origin https://github.com/PcHieuDev/Kiem_tra_thiet_bi.git
git checkout -b main
...
1. Vào https://github.com/PcHieuDev/Kiem_tra_thiet_bi/settings/pages
...
2. Mở https://PcHieuDev.github.io/Kiem_tra_thiet_bi/
...
```
https://PcHieuDev.github.io/Kiem_tra_thiet_bi
```
